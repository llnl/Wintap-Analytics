...
| [[wiki/work/optimize-fileops-poller/test_plan]] | high | Closeout test plan: the six critical milestone tests (build+unit smoke, harness self-test, deploy smoke, the kill-switch A/B differential, collector parquet sanity, fop-14 long-term watch) that supersede the per-slice intermediate tests. |
